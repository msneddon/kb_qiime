...
class QIIME(object):
    ...
    def pick_closed_reference_otus(self, params, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method pick_closed_reference_otus: argument json_rpc_context is not type dict as required.')
